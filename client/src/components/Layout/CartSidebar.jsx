...
const CartSidebar = () => {
  ...
  {/* overlay */}
    ...
    <div className="fixed right-0 top-0 h-full w-96 z-50 glass-panel animate-slide-in-right overflow-y-auto">
      ...
      <div className="flex items-center justify-between p-6 border-[hsla(var(--glass-border))]">
      ...
      <div className="p-6">
        {
          cart && cart.length ===0 ? (
                  ...
                  return(
                    <div key={item.product.id} className="glass-card p-4">
                      <div className="flex items-center space-x-4">
                        ...
                        className="w-16 h-16 object-cover rounded-lg"></img>
                        ...
                        <div className="flex items-center space-x-3 mt-2">
                          ...
                          className="p-1 rounded glass-card hover:glow-on-hover animate-smooth ml-2 text-destructive" 
                            onClick={()=>dispatch(removeFromCart(item.product.id))}>
                              <Trash2 className="w-2 h-2 text-destructive-foreground"></Trash2>
                          </button>
                        </div>
                      </div>
                    </div>
            ...
            <div className="border-t border-[hsla(var(--glass-border))] pt-4">
              ...
              <span className="text-x1 font-bold text-primary">
              ${total.toFixed(2)}
              </span>
              </div>
